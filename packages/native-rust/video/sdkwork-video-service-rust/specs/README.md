...
This directory is the local SDKWork component contract for `sdkwork_video_service`.

- Component root: `sdkwork-video/packages/native-rust/video/sdkwork-video-service-rust`
