...
This directory is the local SDKWork component contract for `sdkwork_video_core`.

- Component root: `sdkwork-video/packages/native-rust/video/sdkwork-video-core-rust`
