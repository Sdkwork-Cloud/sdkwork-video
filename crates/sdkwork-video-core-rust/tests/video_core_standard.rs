...
#[test]
fn plans_video_generation_provider_dispatch_without_transport_metadata() {
    ...
    assert!(vidu.provider_id.is_empty());
    ...
    assert_eq!(volcengine.provider_code, "volcengine");
    ...
    assert_eq!(openai.provider_code, "openai");
}
