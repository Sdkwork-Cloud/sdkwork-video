# SDKWork Video H5 Plugins

## Purpose
Repository/application-local agent extensions and plugin bundles for SDKWork Video H5 application.
...
## Plugin Categories
- H5 build and packaging plugins
- Capacitor iOS/Android build plugins
- TypeScript SDK generation plugins
