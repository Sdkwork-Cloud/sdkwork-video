# SDKWork Video PC Application Agent Instructions
...
This is the PC application root for SDKWork Video. It follows `APP_PC_ARCHITECTURE_SPEC.md` for PC browser, desktop, and large-screen tablet native packaging.

## Local Dictionary Structure

- `AGENTS.md`: local agent entrypoint and relative SDKWORK spec index.
- `sdkwork.app.config.json`: PC application manifest.
...
- PC application architecture: `APP_PC_ARCHITECTURE_SPEC.md`, `APPLICATION_SPEC.md`, `APP_SDK_INTEGRATION_SPEC.md`.
- PC React UI: `APP_PC_REACT_UI_SPEC.md`, `UI_ARCHITECTURE_SPEC.md`, `FRONTEND_SPEC.md`.
- Desktop/Tauri: `DESKTOP_APP_ARCHITECTURE_SPEC.md`, `APP_PC_ARCHITECTURE_SPEC.md`.
- Any code change: `CODE_STYLE_SPEC.md`, `NAMING_SPEC.md`, plus only the touched language/framework spec.

## Build, Test, and Verification

Run `pnpm install`, `pnpm dev`, `pnpm build`, `pnpm typecheck`, `pnpm test` for development and verification.
